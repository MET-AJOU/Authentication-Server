...
@EnableR2dbcRepositories(basePackages = {"com.metajou.authserver.*"}) // R2dbc Repo를 Test에 사용하기 위해 해줌
...
public class AuthInfoServiceTests {
    ...
    public void createAuthInfoTest() {
        AuthInfo user = new AuthInfo("testuser", OAuth2Provider.GOOGLE, "testuser@gmail.com", List.of(new Role[]{Role.ROLE_USER,Role.ROLE_GUEST}));
